# Upload Certificate for Authentication

**Date:** _(add date completed)_

## Description
Steps taken to upload certificate for authentication within the tenant.

## Objectives
- Successfully upload certificate for authentication
