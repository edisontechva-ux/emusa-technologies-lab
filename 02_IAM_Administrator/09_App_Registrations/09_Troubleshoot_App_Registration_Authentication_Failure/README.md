# Troubleshoot App Registration Authentication Failure

**Date:** _(add date completed)_

## Description
Steps taken to troubleshoot app registration authentication failure within the tenant.

## Objectives
- Successfully troubleshoot app registration authentication failure
