# Troubleshoot Workload Identity Sign In Failure

**Date:** _(add date completed)_

## Description
Steps taken to troubleshoot workload identity sign in failure within the tenant.

## Objectives
- Successfully troubleshoot workload identity sign in failure
