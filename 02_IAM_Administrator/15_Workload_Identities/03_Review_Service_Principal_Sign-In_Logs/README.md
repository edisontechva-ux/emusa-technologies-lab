# Review Service Principal Sign In Logs

**Date:** _(add date completed)_

## Description
Steps taken to review service principal sign in logs within the tenant.

## Objectives
- Successfully review service principal sign in logs
