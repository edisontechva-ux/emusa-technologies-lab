# Configure Managed Identity for Azure Resource

**Date:** _(add date completed)_

## Description
Steps taken to configure managed identity for azure resource within the tenant.

## Objectives
- Successfully configure managed identity for azure resource
