# Assign Conditional Access to Workload Identity

**Date:** _(add date completed)_

## Description
Steps taken to assign conditional access to workload identity within the tenant.

## Objectives
- Successfully assign conditional access to workload identity
