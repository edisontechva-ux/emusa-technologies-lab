# Troubleshoot Tenant Wide Service Outage

**Date:** _(add date completed)_

## Description
Steps taken to troubleshoot tenant wide service outage within the tenant.

## Objectives
- Successfully troubleshoot tenant wide service outage
