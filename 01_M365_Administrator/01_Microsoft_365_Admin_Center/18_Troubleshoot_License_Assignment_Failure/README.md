# Troubleshoot License Assignment Failure

**Date:** _(add date completed)_

## Description
Steps taken to troubleshoot license assignment failure within the tenant.

## Objectives
- Successfully troubleshoot license assignment failure
