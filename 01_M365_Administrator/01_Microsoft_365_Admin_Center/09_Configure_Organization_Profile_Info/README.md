# Configure Organization Profile Info

**Date:** _(add date completed)_

## Description
Steps taken to configure organization profile info within the tenant.

## Objectives
- Successfully configure organization profile info
