# Create Cloud PC Provisioning Policy

**Date:** _(add date completed)_

## Description
Steps taken to create cloud pc provisioning policy within the tenant.

## Objectives
- Successfully create cloud pc provisioning policy
