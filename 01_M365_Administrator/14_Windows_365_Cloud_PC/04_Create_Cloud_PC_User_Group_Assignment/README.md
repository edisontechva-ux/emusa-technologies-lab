# Create Cloud PC User Group Assignment

**Date:** _(add date completed)_

## Description
Steps taken to create cloud pc user group assignment within the tenant.

## Objectives
- Successfully create cloud pc user group assignment
