# Troubleshoot Cloud PC Provisioning Failure

**Date:** _(add date completed)_

## Description
Steps taken to troubleshoot cloud pc provisioning failure within the tenant.

## Objectives
- Successfully troubleshoot cloud pc provisioning failure
