# Configure Cloud PC Network Connection

**Date:** _(add date completed)_

## Description
Steps taken to configure cloud pc network connection within the tenant.

## Objectives
- Successfully configure cloud pc network connection
