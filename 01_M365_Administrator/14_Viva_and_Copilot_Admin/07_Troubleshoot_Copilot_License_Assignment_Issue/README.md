# Troubleshoot Copilot License Assignment Issue

**Date:** _(add date completed)_

## Description
Steps taken to troubleshoot copilot license assignment issue within the tenant.

## Objectives
- Successfully troubleshoot copilot license assignment issue
