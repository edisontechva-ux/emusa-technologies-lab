# Retrieve Teams Usage Reports via Graph API

**Date:** _(add date completed)_

## Description
Steps taken to retrieve teams usage reports via graph api within the tenant.

## Objectives
- Successfully retrieve teams usage reports via graph api
