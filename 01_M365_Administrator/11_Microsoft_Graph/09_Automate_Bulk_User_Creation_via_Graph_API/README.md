# Automate Bulk User Creation via Graph API

**Date:** _(add date completed)_

## Description
Steps taken to automate bulk user creation via graph api within the tenant.

## Objectives
- Successfully automate bulk user creation via graph api
