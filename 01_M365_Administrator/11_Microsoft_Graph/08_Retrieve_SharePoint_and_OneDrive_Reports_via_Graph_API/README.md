# Retrieve SharePoint and OneDrive Reports via Graph API

**Date:** _(add date completed)_

## Description
Steps taken to retrieve sharepoint and onedrive reports via graph api within the tenant.

## Objectives
- Successfully retrieve sharepoint and onedrive reports via graph api
