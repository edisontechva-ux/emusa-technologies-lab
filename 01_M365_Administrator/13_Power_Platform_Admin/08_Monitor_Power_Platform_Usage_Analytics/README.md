# Monitor Power Platform Usage Analytics

**Date:** _(add date completed)_

## Description
Steps taken to monitor power platform usage analytics within the tenant.

## Objectives
- Successfully monitor power platform usage analytics
