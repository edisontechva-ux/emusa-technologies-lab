# Manage SharePoint Sites via PowerShell

**Date:** _(add date completed)_

## Description
Steps taken to manage sharepoint sites via powershell within the tenant.

## Objectives
- Successfully manage sharepoint sites via powershell
