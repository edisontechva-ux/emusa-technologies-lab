# Troubleshoot PowerShell Connection Issues

**Date:** _(add date completed)_

## Description
Steps taken to troubleshoot powershell connection issues within the tenant.

## Objectives
- Successfully troubleshoot powershell connection issues
