# Create Shared Mailbox via PowerShell

**Date:** _(add date completed)_

## Description
Steps taken to create shared mailbox via powershell within the tenant.

## Objectives
- Successfully create shared mailbox via powershell
