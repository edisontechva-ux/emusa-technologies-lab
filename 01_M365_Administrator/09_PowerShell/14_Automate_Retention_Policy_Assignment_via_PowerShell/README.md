# Automate Retention Policy Assignment via PowerShell

**Date:** _(add date completed)_

## Description
Steps taken to automate retention policy assignment via powershell within the tenant.

## Objectives
- Successfully automate retention policy assignment via powershell
