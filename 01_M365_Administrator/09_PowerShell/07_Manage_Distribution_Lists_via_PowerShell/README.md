# Manage Distribution Lists via PowerShell

**Date:** _(add date completed)_

## Description
Steps taken to manage distribution lists via powershell within the tenant.

## Objectives
- Successfully manage distribution lists via powershell
