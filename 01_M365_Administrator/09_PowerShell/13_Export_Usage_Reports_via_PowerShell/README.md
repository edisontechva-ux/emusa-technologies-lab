# Export Usage Reports via PowerShell

**Date:** _(add date completed)_

## Description
Steps taken to export usage reports via powershell within the tenant.

## Objectives
- Successfully export usage reports via powershell
