# Configure Mail Flow Rules via PowerShell

**Date:** _(add date completed)_

## Description
Steps taken to configure mail flow rules via powershell within the tenant.

## Objectives
- Successfully configure mail flow rules via powershell
