# Automate Reporting Scripts via Graph API

**Date:** _(add date completed)_

## Description
Steps taken to automate reporting scripts via graph api within the tenant.

## Objectives
- Successfully automate reporting scripts via graph api
