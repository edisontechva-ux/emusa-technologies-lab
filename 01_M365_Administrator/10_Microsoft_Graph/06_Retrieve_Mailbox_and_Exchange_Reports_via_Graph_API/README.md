# Retrieve Mailbox and Exchange Reports via Graph API

**Date:** _(add date completed)_

## Description
Steps taken to retrieve mailbox and exchange reports via graph api within the tenant.

## Objectives
- Successfully retrieve mailbox and exchange reports via graph api
