# Retrieve License Usage via Graph API

**Date:** _(add date completed)_

## Description
Steps taken to retrieve license usage via graph api within the tenant.

## Objectives
- Successfully retrieve license usage via graph api
